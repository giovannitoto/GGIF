...
2.  arguments related to the data preparation;
3.  arguments related to the latent factors;
4.  arguments related to the iterations of the *Adaptive Gibbs Sampler*;
5.  arguments related to the parameters of the model.
